...
import { RadioGroup, Radio, Textarea, Select, SelectItem } from "@nextui-org/react";
...
export const AddDataInspection = () => {
    const initialValues = {
        Kegiatan: '',
        Tanggal: '',
        mulai_pukul: '',
            ...
            {({ isSubmitting, setFieldValue }) => (
                <Form className="space-y-4 shadow p-5">
                    ...
                    <div className="flex flex-col items-start gap-2">
                        <label htmlFor="inspection">Pemeriksaan</label>
                        <Select size='sm' label="Pilih Pemeriksaan" isRequired>
                            {inspections.map((inspection) => (
                                <SelectItem key={inspection.key}>{inspection.label}</SelectItem>
                            ))}
                        </Select>
                    </div>
