...
import { EditParentDataComponent } from '@/components/Settings/Global/ParentData/EditData/EditParentData';
...
const EditChildData = () => {
    return (
        <div>
            ...
            <h2 className='font-semibold text-xl mb-5'>Edit Data Orang Tua</h2>
            <EditParentDataComponent />
        </div>
    )
}
